...
**Fluxo Principal**
O recepcionista acessa a tela de cadastro de alunos.
O recepcionista preenche dados pessoais, contato, endereço e plano.
O sistema valida os dados inseridos.
O sistema salva o cadastro do aluno.
...
**Fluxo Principal**
Recepcionista acessa cadastro do aluno.
Recepcionista altera informações desejadas.
Sistema valida os dados atualizados.
...
**Fluxo Principal**
Recepcionista acessa tela de pagamentos.
Recepcionista seleciona aluno.
Recepcionista registra pagamento (dinheiro, cartão ou PIX).
Sistema registra pagamento e atualiza situação do aluno.
...
**Fluxo Principal**
Sistema verifica data de vencimento da mensalidade.
Sistema compara com pagamentos registrados.
Sistema define status do aluno (regular ou inadimplente).
...
Sistema recebe identificação do aluno.
Sistema verifica regularidade.
Sistema libera entrada.
...
**Fluxo Principal**
Aluno acessa lista de aulas disponíveis.
